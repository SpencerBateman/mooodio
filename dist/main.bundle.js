...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_24__components_search_boards_search_boards_component__ = __webpack_require__("../../../../../src/app/components/search-boards/search-boards.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
AppModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["M" /* NgModule */])({
        ...
        declarations: [
            ...
            __WEBPACK_IMPORTED_MODULE_24__components_search_boards_search_boards_component__["a" /* SearchBoardsComponent */]
        ],
        imports: [
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__components_search_boards_search_boards_component__ = __webpack_require__("../../../../../src/app/components/search-boards/search-boards.component.ts");
...
var APP_ROUTES = [
    ...
    { path: 'searchBoards', component: __WEBPACK_IMPORTED_MODULE_12__components_search_boards_search_boards_component__["a" /* SearchBoardsComponent */] }
];
...
var AdminComponent = (function () {
    function AdminComponent(userService, sharedService, boardService, router) {
        this.userService = userService;
        this.sharedService = sharedService;
        this.boardService = boardService;
        this.router = router;
    ...
    AdminComponent.prototype.createUser = function () {
        var _this = this;
        var newUser = new __WEBPACK_IMPORTED_MODULE_4__models_user_model_client__["a" /* User */]('', '', '', '', [], [], 'DESIGNER');
        this.userService.register(newUser)
            .subscribe(function (data) {
            _this.router.navigate(['/adminEdit/' + data['_id']]);
        });
    };
...
/***/ "../../../../../src/app/components/search-boards/search-boards.component.css":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "../../../../../src/app/components/search-boards/search-boards.component.html":
/***/ (function(module, exports) {

module.exports = "<nav class=\"navbar navbar-default navbar-fixed-top\">\n  <div class=\"container-fluid\">\n    <!--heading on the nav bar-->\n    <p class=\"navbar-header pull-left\">\n      <a class=\"navbar-brand thick\">\n        <b>Profile</b>\n      </a>\n    </p>\n    <!--tick mark-->\n    <p class=\"navbar-text pull-right\">\n      <a (click)=\"updateProfile()\" class=\"navbar-link\">\n        <span class=\"glyphicon glyphicon-ok\"></span>\n      </a>\n    </p>\n  </div>\n</nav>\n<div class=\"container\">\n  <div class=\"row\">\n    <label for=\"searchTerm\">Find a Board by Name:</label>\n    <input id='searchTerm' name='searchTerm' [(ngModel)]='searchTerm' type='text' class='form-control' placeholder='Please Enter A Board Name'>\n    <button (click)=\"searchBoards()\" class=\"btn btn-primary btn-block\">Search</button>\n  </div>\n\n  <ul class=\"list-group\">\n    <li *ngFor=\"let board of boards\" class=\"list-group-item\">\n      <div class=\"row\">\n        <div class=\"col-12\">\n          <a [routerLink]=\"['/board', board['_id']]\">\n            {{board['name']}}\n          </a>\n        </div>\n      </div>\n    </li>\n  </ul>\n</div>\n\n<!-- Footer -->\n<nav class=\"navbar navbar-default navbar-fixed-bottom\">\n  <div class=\"container-fluid\">\n    <p class=\"navbar-text pull-right\">\n      <a [routerLink]=\"['/profile']\">\n        <span class=\"glyphicon glyphicon-user\"></span>\n      </a>\n    </p>\n  </div>\n</nav>\n"

/***/ }),

/***/ "../../../../../src/app/components/search-boards/search-boards.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return SearchBoardsComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/@angular/core.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__services_shared_service_client__ = __webpack_require__("../../../../../src/app/services/shared.service.client.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__services_board_board_service__ = __webpack_require__("../../../../../src/app/services/board/board.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var SearchBoardsComponent = (function () {
    function SearchBoardsComponent(boardService, sharedService) {
        this.boardService = boardService;
        this.sharedService = sharedService;
    }
    SearchBoardsComponent.prototype.ngOnInit = function () {
        this.user = this.sharedService.user || {};
    };
    SearchBoardsComponent.prototype.searchBoards = function () {
        var _this = this;
        this.boardService.searchBoards(this.searchTerm).subscribe(function (res) {
            _this.boards = res;
        });
    };
    return SearchBoardsComponent;
}());
SearchBoardsComponent = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["o" /* Component */])({
        selector: 'app-search-boards',
        template: __webpack_require__("../../../../../src/app/components/search-boards/search-boards.component.html"),
        styles: [__webpack_require__("../../../../../src/app/components/search-boards/search-boards.component.css")]
    }),
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_2__services_board_board_service__["a" /* BoardService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__services_board_board_service__["a" /* BoardService */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_1__services_shared_service_client__["a" /* SharedService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__services_shared_service_client__["a" /* SharedService */]) === "function" && _b || Object])
], SearchBoardsComponent);

var _a, _b;
//# sourceMappingURL=search-boards.component.js.map
